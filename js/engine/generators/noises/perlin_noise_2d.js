...
class Noise2D {
     ...
     * @param octave {Number}
     */
    constructor(diff, seed, loud, octave) {
        this.diff = diff;
        this.seed = seed;
        this.loud = loud;
        this.octave = octave;
...
export class PerlinNoiseStack {
    ...
    constructor(seed, baseHeight, noiseConfigList) {
        ...
        for (let n of noiseConfigList) {
            this.noiseArr.push(new Noise2D(n.diff, this.seed + i, n.loud, n.octave));
            i++;
        }
    }
...
//作者：__阿岳__ https://www.bilibili.com/read/cv23291865/ 出处：bilibili